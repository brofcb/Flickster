package com.mycompany.flicks.flicks;
...
{
    private static final String YOUTUBE_API_KEY = "AIzaSyDO6Go2ZgfreCnarSH4SUtCIkQTY2EB3jg";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        voteAvg.setText(vote);
        Date.setText(movie.getReleaseDate());
        if(movie.getLanguage().equals("en"))
        {
            languageText = "English";
        }
        else if(movie.getLanguage().equals("ja"))
        {
